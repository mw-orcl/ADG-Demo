...
Open up two SSH sessions.  One to the on-premise side and the other to the cloud side.

1. Use labkey as your private key.

2. Connect as the opc user.

On premise side:

```
ssh -i labkey opc@140.238.148.203
```

On cloud side:

```
ssh -i labkey opc@168.138.67.93
```

3. Switch user to oracle for both.
